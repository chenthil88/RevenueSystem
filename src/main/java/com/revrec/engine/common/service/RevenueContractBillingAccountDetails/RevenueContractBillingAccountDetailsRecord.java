...
/**
 * Row mapped from TiDB table `revenueContractBillingAccountDetails`.
 */
public record RevenueContractBillingAccountDetailsRecord(
        Long id,
        ...
        String createdBy,
        String updatedBy
) implements RevenueContractBillingAccountDetails, Serializable {
    public static final String TABLE_NAME = "revenueContractBillingAccountDetails";
}
