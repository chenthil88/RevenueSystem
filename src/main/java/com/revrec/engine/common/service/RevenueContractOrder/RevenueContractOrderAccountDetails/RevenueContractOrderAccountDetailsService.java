package com.revrec.engine.common.service.RevenueContractOrder.RevenueContractOrderAccountDetails;
...
import com.revrec.engine.domain.service.RevenueContractOrder.RevenueContractOrderAccountDetails.RevenueContractOrderAccountDetailsRecordMapper;
 ...
 */
@Service
public class RevenueContractOrderAccountDetailsService {

    private final NamedParameterJdbcTemplate jdbc;
    private final RevenueContractOrderAccountDetailsRecordMapper rowMapper;
    private final NoSqlRecordServer noSqlRecordServer;

    public RevenueContractOrderAccountDetailsService(
            NamedParameterJdbcTemplate jdbc,
            RevenueContractOrderAccountDetailsRecordMapper rowMapper,
