...
/**
 * Maps JDBC columns to {@link RevRecStageRecord}.
 */
@Component
public final class RevRecStageRecordMapper implements RowMapper<RevRecStageRecord> {

    @Override
    public @NonNull RevRecStageRecord mapRow(@NonNull ResultSet rs, int rowNum) throws SQLException {
        int c = 1;
