package com.revrec.engine.domain.service.RevenueContractBillingAccountDetails;
...
/**
 * Maps JDBC columns to {@link RevenueContractBillingAccountDetailsRecord}.
 */
@Component
public final class RevenueContractBillingAccountDetailsRecordMapper implements RowMapper<RevenueContractBillingAccountDetailsRecord> {

    @Override
    public @NonNull RevenueContractBillingAccountDetailsRecord mapRow(@NonNull ResultSet rs, int rowNum) throws SQLException {
        int c = 1;
        ...
        return new RevenueContractBillingAccountDetailsRecord(
                id,
                revenueContractId,
